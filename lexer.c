...
static bool top_treated_as_one(char op){
...
static void lex_finish_expression()
{
    ...
    {
        compiler_error(lex_process->compiler, "You closed an expression that you never openend\n");
    }
}
